export function process(input,output) {
    ...
    if(input && input.dimension && 
        ...
        input.dimension.coicop18 && input.dimension.coicop18.category && input.dimension.coicop18.category.label
    ) {
        ...
        output.categories.coicop18 = new Map(Object.entries(input.dimension.coicop18.category.label))
    } else {
